            ...
            <div className="colorBackground">
                <section>
                    <div className="welcomeArea">
                        <div className="titleImpact">App de hábitos que se <span className="highlight">adapta</span> à sua rotina</div>
                    ...
                    <div className="containerFunctions" id="Functions">
                        ...
                        <div className="blockContainer">
                            <div className="blocksArea">
                                ...
                                <div className="texts">
                                    <div className="upperText">Painel unificado</div>
                                    <div className="downText">Visualize e edite todos os seus hábitos em um só lugar. Simples e direto.</div>
                                </div>
                            </div>
                            <div className="block">
                                <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                                ...
                                <div className="texts">
                                    <div className="upperText">Foco total, sem distrações.</div>
                                    <div className="downText">Pomodoro integrado mantém o foco e afasta as distrações. Só produtividade.</div>
                                </div>
                            </div>
                            <div className="block">
                                <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 37" fill="none">
                                ...
                                <div className="texts">
                                    <div className="upperText">Acompanhe seu progresso.</div>
                                    <div className="downText">Acompanhe seu progresso em tempo real e monitore cada detalhe de perto.</div>
                                </div>
                            </div>
                            <div className="block">
                                <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                                ...
                                <div className="texts">
                                    <div className="upperText">Converse com IA</div>
                                    <div className="downText">Abra o chat e descreva seu novo hábito do seu jeito, sem menus ou formulários engessados.</div>
                                </div>
                            </div>
                            </div>
                ...
                <section>
                    <div className="finalSection">
                        <h2 className="title" id="Download">Pronto para começar um novo hábito?</h2>

                        <div className="square1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="335" height="707" viewBox="0 0 335 707" fill="none">
                        ...
                        <div className="containerButtons">
                            <button className="downloadFree">
                                <div className="txtDownloadFree">Baixe gratuitamente</div>
                                <Image
                                    src={"/download-icon.png"}
                                    width={15}
                                    height={25}
                                    alt="icone de celular para o botão de download"
                                />
                            </button>

                            <button className="downloadGooglePlay">
                                <Image
                                    src={"/download-google.svg"}
                                    width={720}
                                    height={340}
                                    alt="imagem para servir de fundo no botão"
                                />
                            </button>
                        </div>
                    </div>
